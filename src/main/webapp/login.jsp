...
<div class="form-container">
  <form action="registration" name="formDK" method="get">
    <div class="form-row">
      <label class="form-label">First name:</label>
      <input type="text" name="fname" class="form-input wide">
      <span class="hint-text">(max 30 characters a-z and A-Z)</span>
    </div>

    <div class="form-row">
      <label class="form-label">Last name:</label>
      <input type="text" name="lname" class="form-input wide">
      <span class="hint-text">(max 30 characters a-z and A-Z)</span>
    </div>
    ...
    <div class="form-row">
      ...
      <input type="tel" name="phone" class="form-input wide">
    ...
    <div class="form-row">
      ...
      <input type="text" name="city" class="form-input wide">
      <span class="hint-text">(max 30 characters a-z and A-Z)</span>
    </div>

    <div class="form-row">
      <label class="form-label">Pin Code:</label>
      <input type="text" name="pin" class="form-input medium">
      <span class="hint-text">(6 digit number)</span>
    </div>

    <div class="form-row">
      <label class="form-label">State:</label>
      <input type="text" name="state" class="form-input wide">
      <span class="hint-text">(max 30 characters a-z and A-Z)</span>
    </div>

    <div class="form-row">
      <label class="form-label">Country:</label>
      <input type="text" name="country" class="form-input medium" value="India">
    </div>
